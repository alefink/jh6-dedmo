...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, org.jhipster.blog.domain.Category.class.getName() + ".products");
            createCache(cm, org.jhipster.blog.domain.Cart.class.getName());
            createCache(cm, org.jhipster.blog.domain.Product.class.getName());
            createCache(cm, org.jhipster.blog.domain.Product.class.getName() + ".categories");
