...
import org.jhipster.blog.repository.CartRepository;
...
public class CartResourceIT {
    ...
    public void createCart() throws Exception {
        ...
        assertThat(testCart.getCantidad()).isEqualTo(DEFAULT_CANTIDAD);
    ...
    public void updateCart() throws Exception {
        ...
        assertThat(testCart.getCantidad()).isEqualTo(UPDATED_CANTIDAD);
